...
public class ChartUtils {
    ...
    public static ArrayList<Float> getPricesFromServices(RealmList<Service> list) {
        ...
        for (Service service : list) {
            floats.add(MoneyUtils.longToFloat(new BigDecimal(service.getAction().getPrice())));
        }
        return floats;
    }
    ...
    public static ArrayList<Float> getPricesFromInsurances(RealmList<Insurance> list) {
        ...
        for (Insurance insurance : list) {
            floats.add(MoneyUtils.longToFloat(new BigDecimal(insurance.getAction().getPrice())));
        }
        return floats;
    }
    ...
    public static ArrayList<Float> getPricesFromRefuelings(RealmList<Refueling> list) {
        ...
        for (Refueling refueling : list) {
            floats.add(MoneyUtils.longToFloat(new BigDecimal(refueling.getAction().getPrice())));
        }
        return floats;
    }
    ...
    public static ArrayList<Float> getPricesFromExpenses(RealmList<Expense> list) {
        ...
        for (Expense expense : list) {
            floats.add(MoneyUtils.longToFloat(new BigDecimal(expense.getAction().getPrice())));
        }
        return floats;
    }
}
